...
contains
  ...
  subroutine marbl_ciso_interior_tendency_compute( &
    ...
    real (r8), dimension(marbl_domain%km) :: &
         ...
         DO14C_prod,     & ! production of 13C DOCsl (mmol C/m^3/sec)
         DO14Cr_prod,     & ! production of 13C DOCr (mmol C/m^3/sec)
         DO14Ctot_remin,    & ! remineralization of 13C DOCtot (mmol C/m^3/sec)
         DO14C_remin,    & ! remineralization of 13C DOCsl (mmol C/m^3/sec)
         DO14Cr_remin,    & ! remineralization of 13C DOCr (mmol C/m^3/sec)
    ...
    associate(                                   &
         ...
         DOC_remin       => interior_tendency_share%DOC_remin_fields,  & ! INPUT remineralization of DOCsl (mmol C/m^3/sec)
         ...
         DO13C_loc       => tracer_local(marbl_tracer_indices%DO13C_ind,:),  & ! local copy of model DO14Csl
         DO13Cr_loc       => tracer_local(marbl_tracer_indices%DO13Cr_ind,:),  & ! local copy of model DO14Cr
       ...
       do auto_ind = 1, autotroph_cnt
          ...
          case ('Laws')
             ...
             !--------------------------------------------------------------------------
                      ...
                      eps_autotroph(auto_ind,k) = min( eps_autotroph(auto_ind,k), 10.0_r8 )
                      eps_autotroph(auto_ind,k) = max( eps_autotroph(auto_ind,k), 8.0_r8 )
